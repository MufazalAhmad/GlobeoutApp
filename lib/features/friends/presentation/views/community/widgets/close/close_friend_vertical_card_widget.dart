...
import '../../../../providers/remove_friend_provider.dart';

class CloseFriendVerticalCardWidget extends ConsumerStatefulWidget {
  const CloseFriendVerticalCardWidget({
    super.key,
  ...
  @override
  ConsumerState<CloseFriendVerticalCardWidget> createState() =>
      _FriendVerticalCardWidgetState();
}

class _FriendVerticalCardWidgetState
    extends ConsumerState<CloseFriendVerticalCardWidget> {
  ...
  Future<void> onTapRemove() async {
    try {
      ...
      await ref
          .read(removeFriendFromCloseFriendsProvider(widget.friend.id).future);
    } catch (e) {
      setState(() {
        isLoading = false;
      });
